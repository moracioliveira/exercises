...
#
# This function finds the maximum and minimum numbers
# in a list by iterating through the list and updating
# the maximum and minimum variables as necessary.
#
# Implement the test_find_max_min() function
# that tests the find_max_min() function.
...
def test_find_max_min():
    assert find_max_min([1, 2, 3, 4, 5])
    assert find_max_min([10, 5, 7, 3, 8])
    assert find_max_min([-1, -2, -3, -4, -5])
    assert find_max_min([0])
