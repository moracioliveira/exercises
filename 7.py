"""
The following rectangle_area() function is given,
which returns the area of a rectangle with additional argument validation:
...
assert type(rectangle_area('5', '4')) == int